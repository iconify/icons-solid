...
```jsx
import SampleIcon from '@iconify-solid/material-symbols-light/downloading';
...
```jsx
import SampleIcon from '@iconify-solid/material-symbols-light/privacy-tip';
...
```jsx
import SampleIcon from '@iconify-solid/material-symbols-light/filter-drama-outline';
