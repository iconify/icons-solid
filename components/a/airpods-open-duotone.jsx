...
.ox65s-b2u {
  d: path("M2 9L22 9M8 9C8 9.5523 8.4477 10 9 10L15 10C15.5523 10 16 9.5523 16 9");
}
...
</style><g class="nrj6p8qat"><path class="h-s09r4nc"/><path class="ox65s-b2u"/><path class="rj2y4vkzd"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:airpods-open-duotone"} {...others} />);
}
