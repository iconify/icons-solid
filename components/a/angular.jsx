...
</style><defs><linearGradient id="SVGHgWfLdHW" x1="0%" x2="100%" y1="48.065%" y2="50.391%"><stop offset="0%" class="g_wd886vm"/><stop offset="25.687%" class="l2jdq4bin"/><stop offset="33.759%" class="uq7qrm3sb"/><stop offset="56.442%" class="atss36b8b"/><stop offset="100%" class="n6yddmy3y"/></linearGradient><linearGradient id="SVGivbQwcdb" x1="36.615%" x2="33.292%" y1="41.656%" y2="100%"><stop offset="0%" class="ieitm377e"/><stop offset="28.023%" class="gdbl54b5u"/><stop offset="100%" class="hlvywqk5y"/></linearGradient></defs><path fill="url(#SVGHgWfLdHW)" class="yy6gr_07q"/><path fill="url(#SVGivbQwcdb)" class="oh90wybaa"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:angular"} {...others} />);
}
