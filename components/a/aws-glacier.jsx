...
</style><defs><linearGradient id="SVG7R6tZwZW" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="i653v7ard"/><stop offset="100%" class="eix-4pbod"/></linearGradient></defs><path fill="url(#SVG7R6tZwZW)" class="tmbkaq7lv"/><path class="e8gv-dbmk"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:aws-glacier"} {...others} />);
}
