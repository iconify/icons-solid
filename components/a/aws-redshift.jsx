...
</style><defs><linearGradient id="SVGusebDeuy" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="o1-idcc_z"/><stop offset="100%" class="rr6asqhtm"/></linearGradient></defs><path fill="url(#SVGusebDeuy)" class="tmbkaq7lv"/><path class="ns3h61b-r"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:aws-redshift"} {...others} />);
}
