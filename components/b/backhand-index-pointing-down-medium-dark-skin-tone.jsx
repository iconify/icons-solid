...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto:backhand-index-pointing-down-medium-dark-skin-tone"} {...others} />);
}
