...
</style><g class="nrj6p8qat"><path class="g70whwsdk"/><path class="xgaf0nbdt"/><path class="c7--g1yoy"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:badge-check-two-tone"} {...others} />);
}
