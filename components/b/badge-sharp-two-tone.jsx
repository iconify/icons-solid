...
</style><g class="gp_8x1bzb"><path class="g70whwsdk"/><path class="xgaf0nbdt"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:badge-sharp-two-tone"} {...others} />);
}
