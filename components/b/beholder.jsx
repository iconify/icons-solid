...
const content = `<style>.cxnwb0szq {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m28.491 25.98l-.102.308q.046-.161.102-.319c.175-.49.428-.96.75-1.394m-5.623 1.744l-.199.619a4 4 0 0 0-.182.826c-.081.895.19 1.81.76 2.568m-.579-3.394l3.399.014m4.057 2.024l3.834-1.41c.102-.038.206-.073.314-.094q.163-.028.33-.034a7.8 7.8 0 0 1 3.075.484");
}
...
.hfe5y1bcb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m21.19 21.018l21.066-4.38a4.7 4.7 0 0 0 .236-1.22c.074-1.26-.383-2.531-1.238-3.566c-.854-1.034-2.098-1.83-3.493-2.279a6.5 6.5 0 0 0-1.207-.275c-.61-.073-1.229-.037-1.842.003c-8.609.56-17.144 1.771-25.752 2.326q-.61.04-1.22.07c-.266.012-.536.022-.79.087c-.19.048-.371.128-.514.245c-.152.124-.255.284-.363.439c-.142.203-.297.402-.409.618c-.142.275-.214.587-.124.878c.096.312.362.563.576.831c.328.411.54.88.726 1.35c.2.509.374 1.052.234 1.574c-.05.183-.135.357-.182.54a.9.9 0 0 0-.029.28a.55.55 0 0 0 .09.267a.63.63 0 0 0 .447.254l.253.293a6.51 6.51 0 0 0 1.749 5.529c1.338 1.39 3.422 2.283 5.544 2.245c1.796-.032 3.56-.733 4.733-1.881s1.735-2.725 1.509-4.228");
}
...
.jj4gt6mjv {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m22.558 31.817l.597.379c.08.05.161.098.251.135c.09.036.186.06.282.083a8 8 0 0 0 .725.14c1.641.235 3.308-.144 4.926-.474c.07-.014.141-.028.206-.056a.5.5 0 0 0 .204-.156a.5.5 0 0 0 .091-.22a.5.5 0 0 0-.09-.36a.67.67 0 0 0-.334-.238");
}
...
.pxxwvms0w {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M29.753 26.94c-.558-.5-1.397-.766-2.206-.7a1 1 0 0 0-.131.02a.3.3 0 0 0-.118.05a.4.4 0 0 0-.07.073c-.958 1.19-1.467 2.634-1.435 4.072");
}
...
.s9tfzacbw {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M7.608 19.083q.054-.294.097-.59c.08-.555.13-1.115.275-1.66c.487-1.816 2.104-3.388 4.166-4.049m9.202 14.044a3.2 3.2 0 0 0-.143 1.286c.041.449.182.898.474 1.275c.246.319.597.58 1.004.745a2.9 2.9 0 0 0 1.315.198m4.226.286a26 26 0 0 1-.177-.43a3 3 0 0 1-.16-.476c-.112-.492.01-1.009.27-1.458s.654-.837 1.092-1.175a.7.7 0 0 1 .265-.146a.5.5 0 0 1 .239.007c.146.04.259.14.357.24c.487.502.762 1.147.763 1.796c0 .648-.271 1.295-.757 1.798");
}
</style><path class="hfe5y1bcb"/><path class="q2r1tll8f"/><path class="jj4gt6mjv"/><path class="s05s11lkz"/><path class="s9tfzacbw"/><path class="pxxwvms0w"/><path class="cxnwb0szq"/><ellipse class="qd4-s5beb"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:beholder"} {...others} />);
}
