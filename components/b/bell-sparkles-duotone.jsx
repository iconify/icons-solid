...
const content = `<style>.n3_36ub_x {
  d: path("M14.5801 12C15.1706 13.7121 16 14.356 16 15C16 15.5523 15.5523 16 15 16L3 16C2.4477 16 2 15.5523 2 15C2 14 4 13 4 8C4 5.2386 6.2386 3 9 3C10.1256 3 11.1643 3.372 12 3.9996M7.2679 20C7.6252 20.6188 8.2855 21 9 21C9.7145 21 10.3748 20.6188 10.7321 20");
}
...
</style><g class="nrj6p8qat"><path class="n3_36ub_x"/><path class="xon_9ib8a"/><path class="y4tw4vbye"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:bell-sparkles-duotone"} {...others} />);
}
