...
const content = `<style>.cs0qpyjdz {
  fill: var(--svg-color--212124, #212124);
...
</style><path class="cs0qpyjdz"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:braze-icon"} {...others} />);
}
