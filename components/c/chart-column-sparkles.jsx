...
const content = `<style>.dguwovnoa {
  d: path("M3 3L3 19C3 20.1046 3.8954 21 5 21L21 21M8 11L8 8M13 17L13 11M18 17L18 13");
}
...
</style><g class="nrj6p8qat"><path class="dguwovnoa"/><path class="pu_we-u1a"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:chart-column-sparkles"} {...others} />);
}
