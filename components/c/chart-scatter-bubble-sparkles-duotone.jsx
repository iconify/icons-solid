...
</style><g class="nrj6p8qat"><path class="yc13qrljd"/><path class="qpk590b-s"/><path class="podz5_tnk"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:chart-scatter-bubble-sparkles-duotone"} {...others} />);
}
