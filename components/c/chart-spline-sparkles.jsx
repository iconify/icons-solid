...
.zasxk8evd {
  d: path("M4 12L4 20C4 21.1046 4.8954 22 6 22L22 22M8 18C11.2098 17.3367 13.8536 15.0706 15 12C16.1464 8.9294 18.7902 6.6633 22 6");
}
</style><g class="nrj6p8qat"><path class="zasxk8evd"/><path class="a7u234bbf"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:chart-spline-sparkles"} {...others} />);
}
