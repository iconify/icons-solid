...
</style><g class="nrj6p8qat"><path class="xy54sia-t"/><path class="lxr-c948j"/><path class="s1gq2diuh"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:clock-sparkles-duotone"} {...others} />);
}
