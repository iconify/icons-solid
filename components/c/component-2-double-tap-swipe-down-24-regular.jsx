...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"fluent:component-2-double-tap-swipe-down-24-regular"} {...others} />);
}
