...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"openmoji:couple-with-heart-man-man-medium-skin-tone-light-skin-tone"} {...others} />);
}
