...
</style><g class="nrj6p8qat"><path class="qctrx8w3m"/><path class="lxr-c948j"/><path class="gug740nnc"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:dollar-sign-sparkles-duotone"} {...others} />);
}
