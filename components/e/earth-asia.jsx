...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="ezb4jbc1x"/><path class="wzjwhcb9c"/><path class="jsksc0bij"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"pepicons-pop:earth-asia"} {...others} />);
}
