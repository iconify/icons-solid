...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="c440bubqs"/><path class="hgh871smh"/><path class="hdxpysbbn"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"pepicons-pop:earth-europe-circle"} {...others} />);
}
