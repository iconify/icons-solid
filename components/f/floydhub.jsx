...
const content = `<style>.d2ckmqb9d {
  fill: var(--svg-color--3b99ed, #3b99ed);
...
</style><path class="d2ckmqb9d"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:floydhub"} {...others} />);
}
