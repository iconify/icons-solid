...
.njnw5_bbx {
  ...
  d: path("m19.6 17.574l4.764 2.859l-.075.049q-2.345 1.4-4.688 2.811v-2.8z");
}
</style><path class="drz4-pb8k"/><path class="kg_0zpb1m"/><path class="jai_r-yki"/><path class="njnw5_bbx"/><path class="cdoku3blt"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"vscode-icons:folder-type-video-opened"} {...others} />);
}
