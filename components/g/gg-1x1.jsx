...
const content = `<path class="erzf03bmv"/><path class="wvppcgj3a"/><path class="ygdg4sdhg"/><path id="SVGHv4375Wk" class="e2xibjbip"/><use width="36" height="24" href="#SVGHv4375Wk" transform="matrix(0 1.06667 -.9375 0 496 -17)"/><use width="36" height="24" href="#SVGHv4375Wk" transform="matrix(0 -1.06667 .9375 0 16 529)"/><use width="36" height="24" href="#SVGHv4375Wk" transform="rotate(180 256 256)"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"flag:gg-1x1"} {...others} />);
}
