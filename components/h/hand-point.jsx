...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="oahxzcbrl"/><path class="m5gxnmb7u"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"pepicons-pop:hand-point"} {...others} />);
}
