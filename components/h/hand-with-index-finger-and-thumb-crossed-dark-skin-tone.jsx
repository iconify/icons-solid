...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"twemoji:hand-with-index-finger-and-thumb-crossed-dark-skin-tone"} {...others} />);
}
