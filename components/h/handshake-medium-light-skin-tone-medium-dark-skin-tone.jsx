...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto:handshake-medium-light-skin-tone-medium-dark-skin-tone"} {...others} />);
}
