...
.cwwe17_my {
  d: path("M29.336 42.411s3.668-4.465 4.147-6.778c.478-2.313 1.834-2.552 2.87-1.754m-15.39 4.067s-2.472 1.914-7.177 3.19");
}

.fav7u4b7i {
  d: path("M31.693 5.599s4.907 5.98 5.528 8.518m.282-6.149s-.733-1.466-1.467-2.03m-23.918 6.543s-2.256 11.903 4.795 13.708c0 0-3.046 2.764-5.923-2.257m-2.933-4.005s-.452 10.098 3.046 10.888c0 0-.846-.621-1.016-4.288");
}

.g9-yfcbmq {
  d: path("M5.496 34.468s2.009.596 3.422-1.265m4.768-2.338s-1.568 1.297-2.015 2.413l1.946 1.477s1.025-2.12 1.397-3.385m25.898-4.788s.298 1.19 1.488 2.306m-7.663.819s.818 3.496 2.455 3.348m-15.83 4.652s.239-.798-.24-2.154c0 0 7.656.4 9.968-1.435c0 0-.08 1.515.4 2.233c0 0-3.59 2.791-10.128 1.356");
}
...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:honkai-star-rail"} {...others} />);
}
