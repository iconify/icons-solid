...
</style><path class="bnzowtrnb"/><path class="ptk9div2g"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"twemoji:index-pointing-at-the-viewer-dark-skin-tone"} {...others} />);
}
