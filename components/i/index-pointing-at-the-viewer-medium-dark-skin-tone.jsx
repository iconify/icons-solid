...
</style><path class="itfvg44ke"/><path class="snpt5ibwv"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"twemoji:index-pointing-at-the-viewer-medium-dark-skin-tone"} {...others} />);
}
