...
</style><path class="m8iirwo_d"/><path class="zw907vbyh"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"twemoji:index-pointing-at-the-viewer-medium-skin-tone"} {...others} />);
}
