...
.u4mcub82o {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m34.48 11.552l-.412.332c-4.943.19-7.71.441-12.993 2.113l-2.343-1.47l-1.652-2.255c-.446-.609.678-1.674 1.429-1.758L31.215 7.08c1.626.683 2.872 2.314 3.827 3.708m-12 .149l-1.986-2.368m-5.813 19.058l.543 1.079l-.062.73");
}
...
</style><path class="qjqtwlb3x"/><path class="u4mcub82o"/><g class="rm3lzbu0r"><circle class="xfx8n3bei"/><circle class="bu-3z5vlb"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:jujutsu-kaisen-phantom-parade-alt"} {...others} />);
}
