...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"openmoji:kiss-woman-man-dark-skin-tone-medium-skin-tone"} {...others} />);
}
