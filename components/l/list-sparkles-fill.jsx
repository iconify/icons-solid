...
</style><g class="nrj6p8qat"><path class="oui1tdodu"/><path class="yqe6_cdnh"/><path class="yw7siy1-m"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:list-sparkles-fill"} {...others} />);
}
