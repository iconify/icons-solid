...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto:love-you-gesture-medium-light-skin-tone"} {...others} />);
}
