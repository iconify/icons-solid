...
</style><path class="qfjz-2jgs"/><path class="ckt3beb8o"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="foar7xb8s"/><path class="q06f6rs8h"/><path class="ka4a92d_f"/><path class="z7xj5xpda"/><path class="r1dlllpqg"/><path class="vppqoobnx"/><path class="mnu8d2ysc"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:man-facepalming-medium-dark-skin-tone"} {...others} />);
}
