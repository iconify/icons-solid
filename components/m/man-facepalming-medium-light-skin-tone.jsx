...
</style><path class="qfjz-2jgs"/><path class="vhgq2nbtq"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="ts0w0ebyt"/><path class="q0z76j9hc"/><path class="fl7-4fb4j"/><path class="qkj5ji60e"/><path class="r1dlllpqg"/><path class="vh5w0esvs"/><path class="p5vbnmbpn"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:man-facepalming-medium-light-skin-tone"} {...others} />);
}
