...
</style><path class="qfjz-2jgs"/><path class="c_yy9achv"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="vqqf82mfo"/><path class="t3fkbe2gx"/><path class="qq3otccfw"/><path class="h5f-x-b4o"/><path class="r1dlllpqg"/><path class="yuq03ccfr"/><path class="m-1g_oban"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:man-facepalming-medium-skin-tone"} {...others} />);
}
