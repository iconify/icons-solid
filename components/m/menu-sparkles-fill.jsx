...
</style><g class="nrj6p8qat"><path class="d0appmb6v"/><path class="ghqb3jbhi"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:menu-sparkles-fill"} {...others} />);
}
