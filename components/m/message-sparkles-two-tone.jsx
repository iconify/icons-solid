...
</style><g class="nrj6p8qat"><path class="b3_9-ebna"/><path class="xon_9ib8a"/><path class="eelkazb4o"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:message-sparkles-two-tone"} {...others} />);
}
