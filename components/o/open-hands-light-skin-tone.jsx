...
</style><path class="qfc3u6bdc"/><path class="no8i1hqkz"/><path class="nz3e2bc5i"/><path class="wy0ln5bpd"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:open-hands-light-skin-tone"} {...others} />);
}
