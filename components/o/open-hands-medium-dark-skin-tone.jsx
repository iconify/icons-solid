...
</style><path class="rarn1jb6t"/><path class="dil9yhbbd"/><path class="fkcf5-row"/><path class="pk6955api"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:open-hands-medium-dark-skin-tone"} {...others} />);
}
