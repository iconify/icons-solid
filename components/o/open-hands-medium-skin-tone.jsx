...
</style><path class="jwh-56bht"/><path class="t--tihb-j"/><path class="nl8j1ibqt"/><path class="wio4d-h5t"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:open-hands-medium-skin-tone"} {...others} />);
}
