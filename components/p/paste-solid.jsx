...
const content = `<path class="clr-i-solid clr-i-solid-path-1 ii3sxk_um"/><path class="by6kstvdi clr-i-solid clr-i-solid-path-2"/><path class="clr-i-solid clr-i-solid-path-3 ln14d0b8c"/><rect class="clr-i-solid clr-i-solid-path-4 x9twdebli"/><path class="clr-i-solid clr-i-solid-path-5 ed1f8bbyk"/><path class="clr-i-solid clr-i-solid-path-6 x9l4mvb4c"/><path class="m2o3sh-9c"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"clarity:paste-solid"} {...others} />);
}
