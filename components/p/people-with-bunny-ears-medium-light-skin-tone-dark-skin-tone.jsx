...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto:people-with-bunny-ears-medium-light-skin-tone-dark-skin-tone"} {...others} />);
}
