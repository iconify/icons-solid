...
.fmadkabux {
  fill: var(--svg-color--b89278, #b89278);
  d: path("M54.06 25.75s11.31.51 22.32 2.82l7.45 5l-5.55 12.5l-12.4 2.96l-12.5-7.87l-5.74-9.72zm-38.07 15.8l1.49-1.88l1.02-6.52l6.89-4.69l2.68 1.71s1.1-.33 4.42-1.49l4.76 4.74l-11.72 15.73l-9.79-1.52z");
}

.t2vnf0pti {
  fill: var(--svg-color--f79329, #f79329);
  d: path("M14.4 70.19c.15-.17.31-.34.46-.51c2.65-2.66 5.91-3.45 9.65-3.5c.27-.01.55-.01.83 0c4.6.16 10.18 2.27 12.35 6.56c2 3.95 1.55 10.81-3.44 12.46c-.95.31-2.02.56-3.12.76c-1.97.36-4.11.54-6.26.47c-1.98-.07-3.96-.35-5.8-.86c-1.83-.51-3.52-1.25-4.92-2.25c-4.31-3.08-2.73-9.72.25-13.13");
}

.w6t1udb9c {
  fill: var(--svg-color--fcd4b5, #fcd4b5);
  d: path("M56.84 27.66c1.95-5.5 11.69-3.64 14.98-.73c2.84 2.5 3.33 7.39 1.27 10.62c-.7 1.1-1.54 2.43-2.74 3.02c-3.24 1.6-4.29-2.2-6.23-3.79c-1.07-.88-2.29-1.57-3.53-2.19c-2.77-1.38-4.91-3.63-3.75-6.93m-28.76.02c-4.65-1.34-10.96 1.64-12.5 6.24c-.62 1.82-.36 2.92.7 4.44c.63.89 1.92 2.29 3.16 2.04c1.3-.28 1.97-2.55 2.84-3.47c1.3-1.37 2.87-2.39 4.53-3.27c1.21-.64 4.1-1.95 3.57-3.77c-.34-1.22-1.2-1.9-2.3-2.21m99.57 32.05c-.21-.35-.66-.21-.98-.14c-.67.15-1.3.44-1.99.44c-.13 0-.39.02-.5-.05c-.19-.12.05-.65.08-.81c.07-.29.12-.6.14-.91c.06-.58 0-1.18-.21-1.74c-.36-.97-1.07-1.81-1.95-2.36c-1.13-.7-2.51-.94-3.8-.73c-2 .32-3.59 2.1-3.97 4.03c-.09.48-.06.99.04 1.46c.06.29.23.55.37.8c.05.1.35.4.27.51s-.59.05-.71.03c-.49-.05-.96-.22-1.42-.43c-.43-.2-.83-.44-1.21-.73c-.36-.28-.72-.81-1.21-.84c-.41-.03-.82.43-1.07.71c-.57.64-.72 1.51-.83 2.34c-.1.73-.23 1.51.04 2.22c.23.57.62 1.08 1.12 1.44c1.09.77 2.48 1.16 3.94 1.24c1.98.1 4.03-.34 5.77-1.3c.39-.22.77-.46 1.12-.75c.21-.17.39-.39.62-.53c.35-.22.82-.12 1.2-.14c.5-.02 1-.06 1.5-.15c1.31-.24 2.69-.95 3.41-2.12c.24-.39.51-1.03.23-1.49m-6.78-1.32c-.06.21-.15.41-.23.61c-.39.08-1.05-.07-1.4-.26c-.55-.29-.79-.94-.44-1.48c.41-.62 1.23-.72 1.77-.21c.33.32.42.91.3 1.34");
}
</style><path class="fmadkabux"/><defs><path id="SVGHdjRubjo" class="adrkjtotg"/></defs><use href="#SVGHdjRubjo" class="b81j2dl_f"/><clipPath id="SVGKztVveos"><use href="#SVGHdjRubjo"/></clipPath><path clip-path="url(#SVGKztVveos)" class="a7l_nlbwi"/><path class="t2vnf0pti"/><path class="azy01_b0m"/><path class="w6t1udb9c"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto-v1:pig"} {...others} />);
}
