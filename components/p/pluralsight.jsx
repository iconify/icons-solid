...
</style><defs><linearGradient id="SVGoNoExboy" x1="49.999%" x2="49.999%" y1="1.576%" y2="100.443%"><stop offset="0%" class="yqalt7-ym"/><stop offset="100%" class="w4d5g3ckk"/></linearGradient></defs><path fill="url(#SVGoNoExboy)" class="kw-bgtjqc"/><path class="l42sify6k"/><path class="aahb8je3r"/><path class="j3l-ggbcc"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:pluralsight"} {...others} />);
}
