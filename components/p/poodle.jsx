...
const content = `<style>.d3qqavb_k {
  fill: var(--svg-color--2f2f2f, #2f2f2f);
  d: path("M84 35.87s-4.28-.45-7.54.55L50.94 63.33s-1.4 17.47-1.27 18.03c.14.56 12.3 9.65 12.73 9.79c.42.14 24.46-6.43 24.88-6.57s8.11-21.25 8.11-21.25L89.1 41.25z");
}

.fbhtvob_i {
  fill: var(--svg-color--2f2f2f, #2f2f2f);
  d: path("M21.61 46.58c-1.38.63-2.4 1.74-2.68 3.38c-1.3 7.4 7.94 8.74 12.66 5.96c2.22-1.3 2.5-4.75 1.02-6.62c-2.34-2.94-7.71-4.2-11-2.72");
}

.kxckk1bgt {
  fill: var(--svg-color--2f2f2f, #2f2f2f);
  d: path("M26.62 35.23c-1.68 1.64-1.9 4.39-.51 6.12c1.42 1.74 3.94 1.83 5.63.19c1.67-1.64 1.91-4.4.5-6.13c-1.42-1.74-3.95-1.82-5.62-.18");
}

.mp2agxvjc {
  d: path("M25.21 33.51c-.22-.09-.43-.11-.62-.03c-.71.27-1.21 2.69-1.5 3.41c-1.81 4.67-3.25 9.63-2.65 14.7c.85 7.13 7.09 12.05 14.11 12.8c3.06.33 6.23-.03 9.24-.61c1.8-.35 3.66-1.1 5.35-1.82c.8-.35 2.33-1.08 2.77-1.9c.96-1.82.12-4.22.16-6.18c.06-2.63.52-5.33 1.2-7.88c.45-1.7 1.04-3.36 1.73-4.99c.12-.26 1.34-3.06 1.09-3.09c-1.71-.22-3.52.13-5.25-.06c-1.09-.12-2.21-.13-3.34-.13c-1.78 0-3.57-.18-5.34-.29c-3.92-.25-7.72-1.24-11.58-1.82c-1.31-.19-2.52-.67-3.74-1.15c-.43-.18-1.05-.76-1.63-.96");
}
