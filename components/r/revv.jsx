...
const content = `<style>.eg66age2o {
  fill: var(--svg-color--fa0102, #fa0102);
  fill-rule: evenodd;
  d: path("M9.883 7.765a1.06 1.06 0 0 0-1.06 1.059v.53h4.154c.484 0 .876.355.876.793s-.392.795-.876.795h-.566a.946.946 0 0 0-.764 1.496l2.462 3.428a.865.865 0 0 0 1.24.186a.946.946 0 0 0 .18-1.29l-1.674-2.369a2.384 2.384 0 0 0-.797-4.628z");
}
