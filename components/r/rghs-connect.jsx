...
.slgcfjb1l {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M20.262 22.803v-7.932h4.911c2.776 0 5.027 2.255 5.027 5.037s-2.25 5.038-5.027 5.038l4.91 4.921m-7.358-2.458H17.8m2.462 2.462v-4.925");
}
</style><path class="oj-_ur1ll"/><path class="slgcfjb1l"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:rghs-connect"} {...others} />);
}
