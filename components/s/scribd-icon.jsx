...
const content = `<style>.n3m5klblx {
  fill: var(--svg-color--1e7b85, #1e7b85);
...
</style><path class="n3m5klblx"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:scribd-icon"} {...others} />);
}
