...
.xbtbexbmk {
  d: path("M10 3C13.866 3 17 6.134 17 10C17 13.866 13.866 17 10 17C6.134 17 3 13.866 3 10M15 15L21 21");
}
...
</style><g class="nrj6p8qat"><path class="xbtbexbmk"/><path class="z6olv7vbg"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"keyline-icons:search-sparkles-fill"} {...others} />);
}
