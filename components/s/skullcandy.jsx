...
.t1v84bbrk {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M19.834 29.37c2.26 2.539 4.52 5.077 5.012 6.17c.493 1.092-.782.738-1.488.492c-.707-.236-.846-.375-1.489-.493s-1.778-.214-2.474-.107c-.685.107-.931.407-1.167.054c-.236-.354-.46-1.371-.193-2.495s1.039-2.378 1.8-3.62Zm10.688-8.963c3.149 0 5.709 2.495 5.709 5.58c0 3.095-2.56 5.59-5.709 5.59c-3.159 0-5.708-2.495-5.708-5.59c0-3.085 2.549-5.58 5.708-5.58");
}
</style><path class="rt5_dbbvm"/><path class="t1v84bbrk"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:skullcandy"} {...others} />);
}
