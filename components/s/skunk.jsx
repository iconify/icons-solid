...
.wrca1hbbg {
  d: path("M17.117 19.373s2.972-.699 5.835-.534s4.156.534 4.156.534s.734-1.84-2.394-4.569c-3.557-3.103-5.712-5.296-4.483-9.159c1.085-3.41 6.272-6.86 11.46-4.779c-5.463-1.2-8.463 2.02-9.564 3.974s-1.183 4.761 1.624 7.872s5.367 4.761 4.183 6.853c-.401.709-2.175 1.472-4.679.816c-1.882-.491-3.992-1.228-6.138-1.008");
}
</style><path class="i-lqdyp5k"/><g class="t9zxov_6x"><circle class="pk4jgh2pa"/><path class="lq4ndbbfc"/><path class="wrca1hbbg"/></g>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"twemoji:skunk"} {...others} />);
}
