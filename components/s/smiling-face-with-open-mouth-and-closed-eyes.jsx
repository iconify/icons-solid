...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"emojione-monotone:smiling-face-with-open-mouth-and-closed-eyes"} {...others} />);
}
