...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"healthicons:synergist-insecticide-bioassays2x-outline"} {...others} />);
}
