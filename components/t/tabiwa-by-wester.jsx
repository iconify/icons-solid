...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:tabiwa-by-wester"} {...others} />);
}
