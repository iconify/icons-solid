...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"fluent:table-column-top-bottom-arrow-repeat-all-24-regular"} {...others} />);
}
