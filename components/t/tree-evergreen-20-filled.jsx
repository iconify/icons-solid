...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"fluent:tree-evergreen-20-filled"} {...others} />);
}
