...
</style><defs><linearGradient id="SVGrQHrus6t" x1="123.779%" x2="123.779%" y1="0%" y2="698.962%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient><linearGradient id="SVGMrDPGdSy" x1="11.486%" x2="11.486%" y1="-2.194%" y2="512.398%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient><linearGradient id="SVGRhIQYbIo" x1="-153.743%" x2="-153.743%" y1="-62.263%" y2="278.479%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient><linearGradient id="SVGqnU6Ce0L" x1="-153.743%" x2="-153.743%" y1="-178.48%" y2="162.264%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient><linearGradient id="SVG02pnZciE" x1="11.486%" x2="11.486%" y1="-412.397%" y2="102.194%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient><linearGradient id="SVGGjKWIcRy" x1="123.779%" x2="123.779%" y1="-598.961%" y2="100%"><stop offset="0%" class="dc1gk47tf"/><stop offset="100%" class="ojj18acah"/></linearGradient></defs><path fill="url(#SVGrQHrus6t)" transform="translate(419.72)" class="fiv6vzaio"/><path fill="url(#SVGMrDPGdSy)" transform="translate(419.72)" class="m0k32ybnv"/><path fill="url(#SVGRhIQYbIo)" transform="translate(419.72)" class="t6nj9omil"/><path fill="url(#SVGqnU6Ce0L)" transform="translate(419.72)" class="xexm_9big"/><path fill="url(#SVG02pnZciE)" transform="translate(419.72)" class="ygsjbilst"/><path fill="url(#SVGGjKWIcRy)" transform="translate(419.72)" class="ic6_4wk2q"/><path class="hd0qr0b0q"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"logos:turborepo"} {...others} />);
}
