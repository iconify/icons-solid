...
const content = `<g class="cuyn6tgcc"><path class="unklte81i"/><path class="uhqipab8n"/><path class="v8q09l-bp"/><path clip-rule="evenodd" class="l3wbq4-pq"/><path class="a41bnebdk"/></g>`;
