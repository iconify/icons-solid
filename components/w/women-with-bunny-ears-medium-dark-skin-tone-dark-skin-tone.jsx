...
function Component(props) {
	...
	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"noto:women-with-bunny-ears-medium-dark-skin-tone-dark-skin-tone"} {...others} />);
}
