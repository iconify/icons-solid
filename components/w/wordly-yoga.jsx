...
const content = `<style>.ci96zgg6m {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M9.17 13.502v-5h1.81c1.025 0 1.855.752 1.855 1.68s-.83 1.679-1.854 1.679H9.17m25.995-3.359h3.665m-1.832 5v-5M24 8.502zc1.015 0 1.833.739 1.833 1.656v1.688c0 .918-.818 1.656-1.833 1.656s-1.833-.738-1.833-1.656v-1.688c0-.917.818-1.656 1.833-1.656M24 21.5zc1.015 0 1.833.739 1.833 1.656v1.688c0 .917-.818 1.656-1.833 1.656s-1.833-.739-1.833-1.656v-1.688c0-.917.818-1.656 1.833-1.656m-14.83 0h3.665m-1.833 5v-5m23.493 4.995V21.5l2.503 5l2.502-4.993V26.5m-2.506 11.283v.176m-1.138-2.198c0-.356.128-.678.334-.911c.207-.234.492-.378.808-.378c.63 0 1.142.577 1.142 1.29c0 .355-.107.704-.335.91c-.236.215-.811.565-.811 1.11m-12.998.001v.176m-1.138-2.198c0-.356.128-.678.334-.911c.207-.234.493-.378.808-.378c.63 0 1.142.577 1.142 1.29c0 .355-.106.704-.334.91c-.237.215-.812.565-.812 1.11m-12.998.001v.176M9.86 35.761c0-.356.128-.678.335-.911c.206-.234.492-.378.807-.378c.631 0 1.142.577 1.142 1.29c0 .355-.106.704-.334.91c-.237.215-.812.565-.812 1.11");
}
...
</style><circle class="gwn214sba"/><circle class="k_ao5rbjd"/><path class="kdyx-5bui"/><path class="ci96zgg6m"/><circle class="sek6oub6z"/>`;

/** @param props {{width?: string; height?: string;}} */
function Component(props) {
	const [local, others] = splitProps(props, ["width","height"]);

	return (<Icon width={local.width} height={local.height} viewBox={viewBox} content={content} fallback={"arcticons:wordly-yoga"} {...others} />);
}
